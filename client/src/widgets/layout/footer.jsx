...
export function Footer({ title, description, socials, menus, copyright }) {
  return (
    <footer className="relative px-4 pt-8 pb-6 bg-black text-white">
      <div className="container mx-auto">
                  ...
                  {items.map((item) => (
                    <li key={item.name}>
                      <Typography
                        ...
                        rel="noreferrer"
                        variant="small"
                        className="mb-2 block font-normal text-blue-gray-300 hover:text-white"
                      >
                        {item.name}
                      </Typography>
                    </li>
        ...
        <hr className="my-6 border-blue-gray-800" />
...
Footer.defaultProps = {
  ...
  description:
    "Embark on an interstellar journey of knowledge with our space education platform.",
  socials: [
    {
      color: "blue",
      name: "linkedin",
